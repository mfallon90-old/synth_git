...
//void decode_mod_amp() {
//        unsigned int tau, mask, reset;
//        unsigned char x;
//
//        tau = Xil_In32(BASE_ADDR + TAU_ADDR);
//        reset = MOD_AMP_RST & tau;
//        std::cin >> x;
//        switch (x) {
//            case '0' : mask = MOD_AMP_0 | reset; break;
//            case '1' : mask = MOD_AMP_1 | reset; break;
//            case '2' : mask = MOD_AMP_2 | reset; break;
//            case '3' : mask = MOD_AMP_3 | reset; break;
//            default  : mask = MOD_AMP_0 | reset; break;
//        }
//        Xil_Out32(BASE_ADDR + TAU_ADDR, mask);
//        return;
//    }
